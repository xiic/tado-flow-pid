...
FLOW_MIN = os.getenv('FLOW_MIN', 20)
FLOW_MAX_MINUS10 = os.getenv('FLOW_MAX_MINUS10', 75)
FLOW_MAX_PLUS20 = os.getenv('FLOW_MAX_PLUS20', 45)
PARAM_KP = os.getenv('PARAM_KP', 0.0)
PARAM_KI = os.getenv('PARAM_KI', 0.03)
PARAM_KD = os.getenv('PARAM_KD', 0.0)
PARAM_KPOM = os.getenv('PARAM_KPOM', 10.0)
PARAM_POM_WEIGHT = os.getenv('PARAM_POM_WEIGHT', 0.05)
